...
- 修复一些老 Bug，具体是啥看 [Git History](https://github.com/mx-space/kami)
- 样式上有微调
...
进入 `pubic` 目录，根据自己情况修改 `manifest.json` 文件
...
参照以下内容，复制到右边的框中，并根据自己的情况进行修改。以下是 YAML 格式的参考。
